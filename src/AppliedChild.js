                    ...
                    <div className="col-md-9">
                      ...
                      <div className="row">
                          <div className="col-md-6">
                              <h6 className="card-title cfcprimary" > Described amount : {project.amount}<span className="fw-bold text-dark"></span></h6>
                          </div>
                          <div className="col-md-6"> 
                      ...
                      <div className="col-md-3  d-flex justify-content-between align-items-center">
                          <h6 className="card-title cfcprimary" > Status : Applied<span className="fw-bold text-dark"></span></h6>
                      </div>
                  </div>
                </div>
              </div>
